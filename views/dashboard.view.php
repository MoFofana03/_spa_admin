                           ...
                           <div id="testimonial_slider" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner">
                                 <div class="item carousel-item active">
                                    ...
                                    <p class="testimonial">Sed ut perspiciatis unde omnis iste natus error sit
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="progress_bar">
                           ...
                           <div class="progress skill-bar">
                              <div class="progress-bar progress-bar-animated progress-bar-striped" role="progressbar"
                                 aria-valuenow="82" aria-valuemin="0" aria-valuemax="100" style="width: 82%;">
                              </div>
                           </div>
                           <span class="skill" style="width:48%;">Other <span class="info_valume">48%</span></span>
                           <div class="progress skill-bar">
                              <div class="progress-bar progress-bar-animated progress-bar-striped" role="progressbar"
                                 aria-valuenow="48" aria-valuemin="0" aria-valuemax="100" style="width: 48%;">
                              </div>
                           </div>
                        </div>
                     </div>
            ...
            <div class="dash_blog">
               <div class="dash_blog_inner">
                  ...
                  <div class="msg_list_main">
                     <ul class="msg_list">
                        <li>
                           <span><img src="<?= LINK ?>/assets/images/layout_img/msg2.png" class="img-responsive" alt="#" /></span>
                           <span>
                        ...
                        <li>
                           <span><img src="<?= LINK ?>/assets/images/layout_img/msg3.png" class="img-responsive" alt="#" /></span>
                           <span>
                              <span class="name_user">John Smith</span>
