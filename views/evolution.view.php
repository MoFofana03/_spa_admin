                                             ...
                                             <tbody>
                                                <tr>
                                                   ...
                                                   <td>
                                                      <ul class="list-inline">
                                                         <li>
                                                            <img width="40" src="<?= LINK?>assets/images/layout_img/msg2.png" class="rounded-circle" alt="#">
                                                         </li>
                                                         <li>
                                                            <img width="40" src="<?= LINK?>assets/images/layout_img/msg3.png" class="rounded-circle" alt="#">
                                                         </li>
                                                      </ul>
                                                   </td>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                      <ul class="list-inline">
                                                         ...
                                                         <li>
                                                            <img width="40" src="<?= LINK?>assets/images/layout_img/msg4.png" class="rounded-circle" alt="#">
                                                         </li>
                                                      </ul>
                                                   </td>
                                                   <td class="project_progress">
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                      <ul class="list-inline">
                                                         <li>
                                                            <img width="40" src="<?= LINK?>assets/images/layout_img/msg1.png" class="rounded-circle" alt="#">
                                                         </li>
                                                         <li>
                                                            <img width="40" src="<?= LINK?>assets/images/layout_img/msg3.png" class="rounded-circle" alt="#">
                                                         </li>
                                                         ...
                                                         <li>
                                                            <img width="40" src="<?= LINK?>assets/images/layout_img/msg5.png" class="rounded-circle" alt="#">
                                                         </li>
                                                      </ul>
                                                   </td>
                                                   <td class="project_progress">
